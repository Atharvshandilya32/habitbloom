...
export default function ChallengesHub({
  ...
  const handleCreate = (e: React.FormEvent) => {
    ...
    const newChallenge: Omit<SocialChallenge, 'id' | 'createdAt'> = {
      ...
      targetXP: mode === 'team' ? targetXP : undefined,
      currentTeamXP: mode === 'team' ? 0 : undefined,
      startDate,
      endDate,
      participants: {
            ...
            return (
              ...
              >
                <div>
                  ...
                  {/* If Team Mode, show progress bar towards Target XP */}
                  {c.mode === 'team' && (
                    <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800">
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-[10px] font-extrabold text-slate-500 uppercase">Team XP Goal</span>
                        <span className="text-xs font-bold text-indigo-600 dark:text-indigo-400">
                          {c.currentTeamXP || 0} / {c.targetXP || 1000} XP
                        </span>
                      </div>
                      <div className="h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                        <motion.div
                          ...
                          initial={{ width: 0 }}
                          animate={{ width: `${Math.min(100, ((c.currentTeamXP || 0) / (c.targetXP || 1000)) * 100)}%` }}
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="team">Team (Co-op XP)</option>
                    </select>
                  </div>
                </div>
                ...
                {mode === 'team' && (
                  <div>
                    ...
                    <p className="text-[10px] text-slate-500 mt-1">
                      Everyone in the challenge pools XP together to reach this target!
                    </p>
                  </div>
                )}
